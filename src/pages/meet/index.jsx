...
const MeetOurTeam = () => {
  ...
  return (
    <section
      id="team"
      ref={ref}
      className="dark:bg-bg-color-dark bg-gray-light relative z-1 py-16 md:py-20 lg:py-28 overflow-hidden"
    >
      <div className="container">
        ...
        >
          <SectionTitle
            title="Meet Our Team"
            paragraph="At Top Company, we value collaboration.Meet with our team to share your ideas, discuss challenges, and explore tailored digital solutions. Together, we'll turn your vision into reality."
            center
          />
        </motion.div>
        ...
        <motion.div
          ...
          initial="hidden"
          animate={isInView ? "show" : "hidden"}
          className="grid grid-cols-1 gap-x-4 gap-y-10 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4"
        >
          {meetOurTeamData.map((meetOurTeam) => (
            <motion.div key={meetOurTeam.id} variants={itemVariants}>
              <SingleMeet MeetOurTeam={meetOurTeam} />
            </motion.div>
          ))}
        </motion.div>
      </div>
