...
const NewsLatterBox = () => {
  ...
  return (
    ...
    >
      ...
      >
        Stay updated with Nuvayra's latest tech solutions and innovations. Get
      ...
      <motion.div variants={itemVariants}>
        ...
        <Input
          ...
          className="mb-6"
        />
        <Button type="submit" size="sm" className="w-full mb-6 rounded-none">
          Subscribe
        </Button>
        ...
        <span className="absolute top-7 left-2">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop
                  stopColor={theme === "light" ? "#00B4d8" : "#fff"}
                  stopOpacity="0.62"
                />
                <stop
                  offset="1"
