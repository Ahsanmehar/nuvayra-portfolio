...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="bg-white relative z-1 dark:bg-gray-dark overflow-hidden pt-50"
    >
      <div className="container">
        <motion.div
          ...
          className="flex flex-col items-center gap-x-30 gap-y-2 lg:flex-row"
        >
          <div className="w-full lg:max-w-[700px]">
            <motion.h4 variants={textItem} className="text-primary">
              Top Company
            </motion.h4>
            <motion.h1
              variants={textItem}
              className="my-5 text-3xl leading-tight font-bold text-black dark:text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight "
            >
              Welcome to Our Software Agency – <TypingAnimation />
            </motion.h1>
            <motion.p
              variants={textItem}
          ...
          <motion.div variants={imageItem} className="lg:max-w-[700px]">
            <img
              src={hero.hero}
      ...
      <div className="absolute top-0 right-0 z-[-1] opacity-30 lg:opacity-100">
        ...
        >
          ...
          <defs>
            ...
            >
              <stop offset="0.145833" stopColor="#00B4d8" stopOpacity="0" />
              <stop offset="1" stopColor="#00B4d8" stopOpacity="0.08" />
            </radialGradient>
            <radialGradient
